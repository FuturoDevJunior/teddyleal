...
export interface IUserService {
  register(data: { name: string; email: string; password: string; tenantId: string }): Promise<User>;
...
export class UserService implements IUserService {
  ...
  async register(data: { name: string; email: string; password: string; tenantId: string }): Promise<User> {
